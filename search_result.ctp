        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-9">
                  ...
                  <?php //pr($list_all); ?>
                        <?php if(isset($list_all) && !empty($list_all)){ 
                            foreach($list_all as $prd){ ?>
                        <?php 
                       //print_r($prd['Product']);exit; 
                        //$avg = ProductsController:avg_rating($prd['Product']['id']);
                     //$this->requestAction('products/avg_rating/3');
                        ...
                        <div class="col-lg-4 col-sm-6 col-12 col-product">
                            <figure class="mt-4">
                                ...
                                <span class="text-grey">(71)</span>
                                    ...
                                    <h6 class="float-left mt-2 font-weight-bold">$<?php echo $prd['Product']['price_lot']; ?></h6>
