...
<div class="container_960">
   ...
   <div id="resdiv">
	...
	?>
	 <div id="ovr<?php echo $k; ?>" class="img-holder" onclick="myClick('<?php echo base64_encode($serchskill['Skill']['id']);?>',event)" onmouseover="open_overlay(<?php echo $k;?>)" onmouseout="close_overlay(<?php echo $k;?>)">
	   <?php 
			...
			{
	  ?>
		<img alt="<?php echo $serchskill['Skill']['skill_name'];?>" src="<?php echo $this->webroot;?>skill_images/<?php echo $skillimages_exp[0];?>"/>
      <?php
		}}
		else{
	  ?>
