		...
		<div class="block">
			...
			<?php echo $this->Form->create('City',array('enctype'=>'multipart/form-data')); 
				...
				?>
                              ...
                              <input  type="hidden" id="lat" name="data[City][latitude]" value="<?php echo $this->request->data['City']['latitude']?>"/>
                              <input  type="hidden" id="long" name="data[City][longitude]" value="<?php echo $this->request->data['City']['longitude']?>"/>
