	...
	<div class="row-fluid">
		...
		<div class="block">
			...
			<?php echo $this->Form->create('User',array('enctype'=>'multipart/form-data')); ?>
				...
				?>
				   <span style="float:left"><input type='radio' name='data[User][gender]' id="male" required value="M" <?php if(isset($this->request->data['User']['gender'])&&$this->request->data['User']['gender']=='M'){echo 'checked';}?>>&nbsp;Male&nbsp;&nbsp;&nbsp;&nbsp;</span><span style=
