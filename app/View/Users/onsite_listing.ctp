            	...
            	<div class="profile_rapper">
                  ...
                  <div class="col-md-9"> 
                        <div class="personal_profile">
                          ...
                          <a href="<?php echo $this->webroot; ?>users/on-site-listing/create-new"><input class="btn btn-default btn-sm" value="Create New" type="button" style="float:right;margin-top: 6px;background:#e50516;color: #fff;"></a>                        
                        </div>
                  	<div class="panel">       
                        <?php 
                  	  if(!empty($spas)){ 
                                    ...
                                    <div class="right-photo-view">
                                      <div class="list-width-map photo-view-list">
                                        <div class="profile_agent">
                                          <input class="btn btn-default btn-sm" value="Edit" type="button" style="background:white;border:1px solid #ccc;margin-right:5px;" onclick="location.href='<?php echo $this->webroot;?>users/onsite-listing/edit/<?php echo base64_encode($spa['Spa']['id']);?>'">
                                          <input class="btn btn-default btn-sm" value="Duplicate" type="button" style="background:white;border:1px solid #ccc;margin-right:5px;" onclick="location.href='<?php echo $this->webroot;?>users/duplicate_onsite/<?php echo base64_encode($spa['Spa']['id']);?>'">
                                          ...
                                          <input class="btn btn-default btn-sm" value="Post" type="button" style="background:#2C87F0;color: #fff;">
                                        </div>
                                        <div>
...
<script>
 function del(id)
 {
  tt=confirm("Are you sure you want to delete this on-site listing?");   
  if(tt){
  location.href="<?php echo $this->webroot;?>users/onsite_delete/"+id;    
  }
 }
</script>