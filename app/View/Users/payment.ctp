...
<form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post" name="membershipform">
    ...
    <input type="hidden" name="item_name" value="Shop Creation on TWOP">
    <input type="hidden" name="item_number" value="Monthly">

    <!-- Set the terms of the regular subscription. -->
    <input type="hidden" name="currency_code" value="GBP">
    <input type="hidden" name="a3" value="<?php echo $sitesetting['SiteSetting']['shop_price_per_month']?>">
    ...
    <input type="hidden" name="custom" value="<?php echo $this->params['pass'][0];?>">
...
<script>
	...
	//alert(id);
	document.membershipform.amount.value = id;
	//document.membershipform.custom.value = id;
	//document.membershipform.submit();
    }
    function formSubmit(){
