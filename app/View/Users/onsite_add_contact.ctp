                     ...
                     <div class="personal_profile">
                         <div class="personal_tables">  
								...
								<input type="hidden" name="data[Spa][address_id]" value="<?php echo(!empty($spaAddress)?$spaAddress['SpaAddress']['id']:'0');?>" id="address_id"/>
                                  ...
                                  <div class="form-group">
                                    <label for="inputPassword3" class="col-sm-2 control-label">Service Area from center of the city*</label>
                                    <div class="styled-select slate col-sm-10" style="width:79.7%;margin-left:16px;border-radius: 2px;border:0px;">
                                        <select class="form-control" id="distance_unit" name="data[Spa][distance_unit]" style="border: 1px solid #ccc;">
                                          <option value="">Select Option</option>
                                          <option value="km" <?php echo(!empty($spaAddress)?($spaAddress['SpaAddress']['distance_unit']=='km'?'Selected':''):'');?>>Kilometer</option>
                                          <option value="mile" <?php echo(!empty($spaAddress)?($spaAddress['SpaAddress']['distance_unit']=='mile'?'Selected':''):'');?>>Mile</option>
                                        </select>
                                        <br/>Distance<br>
                                        <input class="form-control" id="distance" type="text" name="data[Spa][distance]" style="margin-bottom:10px;" onkeypress="return numbercheck(event);" value="<?php echo(!empty($spaAddress)?$spaAddress['SpaAddress']['distance']:'');?>">
                                    </div>
                                  </div>
...
float: left;margin-right: 10px; border-radius:2px;">
                                  ...
                                  <div class="form-group">
                                    <div class="col-sm-offset-2 col-sm-10">
                                      <button type="submit" class="btn btn-default signin" id="overviewbtn" onclick="return onsite_contact_validate();">Save</button>
                                    </div>
                                  </div>
                                </form>                                
                            	</div>              
