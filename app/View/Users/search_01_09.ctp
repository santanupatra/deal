...
var latitude_city="<?php echo $lat;?>";
var longitude_city="<?php echo $long;?>";
...
var noPoi = [
 {
  ...
  google.maps.event.addListener(map,'dragend',function(event) {
	 ...
	 $("#frame").attr("src", '<?php echo($this->webroot);?>skills/mapframe/'+lat0+'/'+lng0+'/'+lat1+'/'+lng1+'/'+search_text+'/'+amt1+'/'+amt+'/'+center0+'/'+center1);

	 $('#main_result_map_div').hide();
	 $('#frame').show();
