    ...
    <div class="row-fluid">
        ...
        <div class="block">
            <div class="navbar navbar-inner block-header">
                    <div class="muted pull-left"><?php echo __('Edit Faq'); ?></div>
            </div>
            ...
            <fieldset>
                ...
                echo $this->Form->input('question',array('value'=>$faq['Faq']['question'],'style'=>'width:500px;'));
                echo $this->Form->input('answer',array('value'=>$faq['Faq']['answer'],'style'=>'width:500px;'));
