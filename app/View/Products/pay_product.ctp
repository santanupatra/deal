			...
			<div class="row">
				...
				<div class="col-md-9">
					...
					<div class="dash_middle_sec seller_membership" style="padding: 60px 40px;margin:0 auto;">
						<h3>Your do not have any more free listing for products. You need to Pay <?php echo $sitesetting['SiteSetting']['price_per_listing']?> GBP for each product you add to show it on the site. Click 'Pay by PayPal' button to pay for the product or you can add more product and pay it later from Inventory listing section.</h3>	
						...
						<div style="margin:0 auto;text-align:center;margin-top: 20px;">
							...
							<a href="<?php echo $this->webroot.'products/add_product';?>" style="margin: 0 auto;color: white;text-decoration: none;"><button style="margin-left: auto;color: white;">Add another product</button></a>
						</div>
					</div>
					    <div>&nbsp;</div>
