            ...
            <div class="row">
                ...
                <div class="col-lg-9 col-12">
                    <div class="right-side p-3">
                        <h2 class="text-pink">Deal List</h2>
<!--                        <div class="bg-light p-4">
                        ...
                        <div class="row mt-3 pb-3 product-list-row">
                            <div class="col-lg-2 col-md-3 col-4">
                                ...
                                <img src="<?php echo($this->webroot)?>product_images/<?php echo($product['Product']['product_image']);?>" alt="" class="img-fluid">
                                <?php }else{ ?>
                            ...
                            <div class="col-lg-6 col-md-6 col-12">
                                ...
                                <h6>Price : <span class="text-pink font-weight-bold"><?php echo '$'.$product['Product']['price_lot'];?></span></h6>
