            ...
            <div class="mb-4 order-area">
              <div class="table-responsive">
                        ...
                        <div style="width:100px" class="prod-image">
                            <img src="<?php echo($this->webroot)?>product_images/<?php echo($or['Product']['ProductImage'][0]['name']);?>" alt=""  width='100px' height='80px'>
                            <!--class="img-fluid"-->
                        </div>
  	    							</td>
  	    							...
  	    							<td class="text-right">
                                                                    ...
                                                                    <?php if($or['OrderDetail']['order_status']=='C'){?>
                                                                    <div class="">
                                                                    <a class="btn btn-secondary btn-sm remove">Order Canceled</a></div><?php }else{ ?>
                                                                    
                                                                    
                                                                    <div class="">
<!--                          <a class="btn btn-secondary btn-sm remove" href="#">Cancel</a>-->
                          <a class="btn btn-primary btn-sm remove" href="<?php echo($this->webroot);?>products/view_order_details/<?php echo $or['OrderDetail']['id']?>">View</a>
                        </div>
                                                                    <?php } ?>
  	    							</td>
  	    						</tr>
