                ...
                <div class="right-side p-3">
                    ...
                    <div class="row">
                        <div class="col-lg-7 col-12">
                            <form class="form-area" method="post" action="<?php echo $this->webroot; ?>products/add_product" id="frmEdit">
                                ...
                                <div class="form-group">
                                    <label>SKU</label>
                                    <input type="text" class="form-control" required="" name="data[Product][product_code]"   placeholder="Product code here">
                                </div>
                                ...
                                <div>
                                    <div class="company-images">
                                      <!--<img src="<?php echo $this->webroot; ?>images/company-images-blank.png" alt="">-->
                                        ...
                                        <div class="fileUpload btn btn-primary" style=" position: relative; ">
                                            <span>Add Image</span>
                                            <input type="file" id="multiFiles" required="" name="files[]" multiple="multiple" class="upload"  />
                                        </div>

                                        <span id="status" ></span>
                                    </div>
                                    <div class="manage-photo" id="product_images" style="overflow:scroll; height:450px;width:450px;">
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Add Color Variation</h4>
...
<script type="text/javascript">
                ...
                success: function (response) {
                    ...
                    if (obj.Ack == 1) {
                        ...
                        for (var i = 0; i < obj.data.length; i++) {
                            ...
                            $('<li id="' + obj.data[i].last_id + '"></li>').appendTo('#sortable').html('<div class="media" id="image_' + obj.data[i].last_id + '"><div class="media-left"><a href="#"><img style="width: 100px; height: 100px" src="' + file_path + '" alt="" /></a></div><div class="media-body media-middle"><h4>' + obj.data[i].filename + '</h4></div><div class="media-body media-middle"></div></div></li>');
                        }
                    }
                },
    ...
    function delete_image() {
        ...
        $.each($("input[name='data[Product][product_image_name]']"),
                function () {
