...
<link rel="stylesheet" href="<?php echo $this->webroot; ?>flat-ui/bootstrap/css/bootstrap.css">
<link rel="stylesheet" href="<?php echo $this->webroot; ?>flat-ui/css/flat-ui.css">
<!-- Using only with Flat-UI (free)-->
<link rel="stylesheet" href="<?php echo $this->webroot; ?>common-files/css/icon-font.css">
<!-- end -->
<link rel="stylesheet" href="<?php echo $this->webroot; ?>common-files/css/animations.css">
<?php	
  echo $this->Html->css(array('style','jquery-ui','validationEngine.jquery','jquery.bxslider','onepage-scroll','coverphoto'));
?>
<link href='http://fonts.googleapis.com/css?family=Montserrat:700' rel='stylesheet' type='text/css'>
<link href='http://fonts.googleapis.com/css?family=Montserrat' rel='stylesheet' type='text/css'>
<link href='http://fonts.googleapis.com/css?family=Lato' rel='stylesheet' type='text/css'>
<link href='http://fonts.googleapis.com/css?family=Lusitana' rel='stylesheet' type='text/css'>
<link rel="stylesheet" href="<?php echo $this->webroot; ?>css/flexslider.css" type="text/css" media="screen" />

<div class="search_hold_1">
...
<?php
  echo $this->Html->script(array('jquery-1.8.3','jquery.validationEngine','jquery.validationEngine-en','jquery-ui','jquery.notifyBar','jquery.bxslider','script','jquery.onepage-scroll','jquery.flexslider','coverphoto.min'));
?>
<script src="<?php echo $this->webroot; ?>flat-ui/js/bootstrap.min.js"></script>
<script src="<?php echo $this->webroot; ?>common-files/js/modernizr.custom.js"></script>
<script src="<?php echo $this->webroot; ?>common-files/js/page-transitions.js"></script>
<script src="<?php echo $this->webroot; ?>common-files/js/jquery.scrollTo-1.4.3.1-min.js"></script>
<script src="<?php echo $this->webroot; ?>common-files/js/startup-kit.js"></script>
<script src="<?php echo $this->webroot; ?>common-files/js/froogaloop.min.js"></script>
<script src="<?php echo $this->webroot; ?>common-files/js/jquery.parallax.min.js"></script>
<script src="<?php echo $this->webroot; ?>common-files/js/jquery.backgroundvideo.min.js"></script>
...
var search_text='<?php echo ((isset($search_text) && $search_text!="empty")?$search_text:"empty");?>';
...
var noPoi = [
 {
  ...
  google.maps.event.addListener(map,'dragend',function(event) {
	...
	//window.location.href='<?php echo($this->webroot);?>users/search_result/'+lat0+'/'+lng0+'/'+lat1+'/'+lng1+'/'+search_text;
  });
