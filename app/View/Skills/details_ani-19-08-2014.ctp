...
?>
<div class="profile_cover_photo" style="background:url(<?php echo $bgbanner;?>) no-repeat; width:100%; background-size: none;">
	...
	<div class="container_960">
		...
		<div class="share_link">
		     <span id="wishlisticon">
				 ...
				 ?>
					<a href="javascript:void(0);" onclick="make_fav(<?php echo $skill['Skill']['id'];?>)"><img src="<?php echo $this->webroot;?>img/share1_black.png" title="Remove from wishlist"></a>
				 <?php }else{ ?>
				   <a href="javascript:void(0);" onclick="make_fav(<?php echo $skill['Skill']['id'];?>)"><img src="<?php echo $this->webroot;?>img/share1.png" title="Add to wishlist"></a>
				 <?php } ?>
			  </span>
...
<div class="profile_product">
	<div class="container_983" style="height:auto;">
		<ul class="profile_product">
		 <?php foreach($recommendskill as $recommendskl){ ?>
			<li>
				<img src="<?php echo $this->webroot;?>skill_images/<?php echo $recommendskl['Skill']['banner'];?>" alt="Banner" />
				<aside>
...
<?php echo $this->Html->scriptStart(array('inline'=>false));?>
	...
	function make_fav(skill_id)
	{
	 $.post( '<?php echo($this->webroot)?>skills/make_wishlist/'+skill_id, function( data ) {
	   $('#wishlisticon').html('');
	   $('#wishlisticon').html(data);
	 });
	}
