<div class="skills index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('skill_details'); ?></th>
			<th><?php echo $this->Paginator->sort('is_active'); ?></th>
			<th><?php echo $this->Paginator->sort('skill_workshop_address'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($skill['Skill']['skill_details']); ?>&nbsp;</td>
		<td><?php echo h($skill['Skill']['is_active']); ?>&nbsp;</td>
		<td><?php echo h($skill['Skill']['skill_workshop_address']); ?>&nbsp;</td>
		<td class="actions">
