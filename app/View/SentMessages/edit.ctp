...
<?php echo $this->Form->create('SentMessage'); ?>
	<fieldset>
		<legend><?php echo __('Edit Sent Message'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('SentMessage.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('SentMessage.id'))); ?></li>
