    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 col-sm-6">
                <div class="breadcmb">
                    <a href="<?php echo $this->webroot.'orders/seller_disputes';?>">Dispute List</a> > <a href="" class="active">Dispute Detail</a>
                </div>
            </div>
            <div class="col-md-6 col-sm-6">
                <?php if(isset($seller_response) && $seller_response==0){?>
                <p class="text-right">
                    <a href="" class="btn btn-default" data-toggle="modal" data-target="#RejectDispute">Reject</a>
                    <a href="" class="btn btn-primary" data-toggle="modal" data-target="#AcceptDispute">Accept</a>
                </p>
                <?php }?>
            </div>
        </div>
        <div class="row">
                        ...
                        <table class="table table-bordered prod-history-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php if(isset($dispute_images) && count($dispute_images)>0 && $LoopCnt==1){?> <a href="Javascript: void(0);" title="View" class="atch_btn show_attach_img" style="border: none; background-color: #fff;"></a> &nbsp; <a href="Javascript: void(0)" class="dwnld_file" id="<?php echo base64_encode($dispute_id);?>" title="Download"><i class="fa fa-download" aria-hidden="true"></i></a><?php }?></td>
                                </tr>
                                <?php
                                    }
                                }else{
            ...
            <div class="col-lg-12" id="LeaveMessageDiv">
                <h4>Leave a message for the buyer</h4>
    ...
    <div class="modal-dialog dispute-request">
        <div class="modal-content">
            ...
            <form class="form-horizontal" method="post" action="">
                ...
                <input type="hidden" name="order_details_id" value="<?php echo isset($order_details_id)?$order_details_id:'';?>">
                <div class="modal-body">
                    <h5 class="red-txt text-center" style="margin-bottom: 15px;">By accepting the open dispute request this means you agree with the buyer's reason</h5>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            ...
                            <input type="number" min="1" class="form-control" id="EnterAmount" max="<?php echo $payment_received;?>" name="partial_amount" placeholder="Enter Amount" style="width: 60%; margin-top:15px; display: none;"/>
                        </div>
                    </div>
                    <div class="form-group">
...
$(document).ready(function(){
    ...
    $('.dwnld_file').click(function(){
        var DisputeImgId=$(this).attr('id');
        if(DisputeImgId!=''){
            window.location = '<?php echo $this->webroot;?>orders/download_file/'+DisputeImgId;
        }
    }); 
