		    ...
		    <?php echo($this->element('user_leftbar'));?>
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="row">
                            ...
                            <li role="presentation" class="default_hide"><a href="Javascript: void(0);" title="Flag" class="flag_check"><i class="fa fa-flag"></i> Flag</a></li>
                            <li role="presentation" class="default_hide"><a href="Javascript: void(0);" title="Unflag" class="unflag"><i class="fa fa-flag"></i> Unflag</a></li>
                            <li role="presentation" class="active"><a href="<?php echo $this->webroot.'orders/buyer_message';?>">Inbox</a></li>
                            <li role="presentation" class=""><a href="<?php echo $this->webroot.'orders/buyer_sent';?>" title="Sent">Sent</a></li>
                            <li role="presentation" class="folder"><a href="<?php echo $this->webroot.'orders/buyer_folder';?>">Folder</a></li>
                                    ...
                                    <table class="table buyer-msg-table">
                                        ...
                                        if(count($messages_list)>0){
                                            ...
                                            foreach ($messages_list as $message): 
                                                ...
                                                $buyer_is_flag=isset($message['Comment']['buyer_is_flag'])?$message['Comment']['buyer_is_flag']:'';
                                                $buyer_folder_id=isset($message['Comment']['folder_id'])?$message['Comment']['folder_id']:'';
                                                ...
                                                if($buyer_folder_id!=0){
                                                    $get_folder_details=$this->requestAction(array('controller' => 'orders', 'action' => 'get_folder_details', $buyer_folder_id, 'admin'=>false, 'prefix' => ''));
                                                    $folder_name=isset($get_folder_details['MailFolder']['folder_name'])?$get_folder_details['MailFolder']['folder_name']:'';
                                                }else{
                                                    $folder_name='';
                                                }
                                        ?>
                                            <tr class="<?php echo $read_class;?>">
                                                <td>
                                                    <div class="flag"><a href="<?php echo $this->webroot.'orders/buyer_flag/'.base64_encode($msg_id).'/'.base64_encode($buyer_is_flag);?>" <?php if($buyer_is_flag==1){ echo 'style="color: #b60e09;"';}?> class="fa fa-flag" onclick="return confirm('Are you Sure?');"></a></div>
                                                    <!--<div class="flag"><a href="Javascript: void(0);" <?php if($buyer_is_flag==1){ echo 'style="color: #b60e09;"';}?> class="fa fa-flag" title="<?php //echo $folder_name;?>"></a></div>-->
...
<script> 				
	...
	$(".delete_data").click(function () {
        ...
        $(".flag_check").click(function () {
            if ($(".inbox_del_msg:checked").length > 0) {
		if(confirm('Are you sure to flag this message?')){
                    $('#messageType').val('Flag');
                    document.InboxMsgFrm.submit();
		}else{
        ...
        $(".unflag").click(function () {
            if ($(".inbox_del_msg:checked").length > 0) {
		if(confirm('Are you sure to unflag this message?')){
                    $('#messageType').val('Unflag');
                    document.InboxMsgFrm.submit();
		}else{
