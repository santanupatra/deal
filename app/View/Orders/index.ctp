...
.text_border{ padding: 4px; border: 1px solid #000;margin-left: 5px;}
</style>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="order-search">
                                        <ul>
                                            <li class="selected"><a href="<?php echo $this->webroot.'orders/index';?>">All Orders <span>(<?php echo isset($seller_all_order)?$seller_all_order:'';?>)</span></a></li>
                                            ...
                                            <li class="active"><a href="<?php echo $this->webroot.'orders/seller_completed';?>">Completed <span>(<?php echo isset($seller_complete_product)?$seller_complete_product:'';?>)</span></a></li>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <ul class="product_action">
                                ...
                                <li><a href="">Amount * Qty</a></li>
                                <li><a href="">Order Status</a></li>
                                <li><a href="">Action</a></li>
                            </ul>
                            <ul class="product_boxes">
                                <?php //echo h($this->requestAction('orders/getUsername/'.$order['Order']['user_id'])); ?>
                                <?php 
					...
					$buyerfeed = $this->requestAction(array('controller' => 'orders', 'action' => 'get_feed', $order_details_id,$order_user_id, 'admin'=>false, 'prefix' => ''));
                                    ...
                                    <div class="order-bottom">
                                            ...
                                            <div class="order_b_3 padding-top_center">
                                                ...
                                                if($order_status=='C' && isset($seller_responce) && $seller_responce==0){
                                                    ...
                                                    if(count($prd_disput_details)>0){
                                                        echo '<p><b>Buyer Dispute Product.</b></p>';
                                                        echo isset($prd_disput_details['Dispute']['select_reason'])?$prd_disput_details['Dispute']['select_reason']:'';
                                                    }
                                                }
						 ...
						 ?>
                                            ...
                                            <div class="order_b_4 padding-top_center">
                                                ...
                                                <a href="Javascript: void(0);" class="ConfirmCancellation" details_id="<?php echo $order_details_id;?>" style="color: #fff;"><button class="active">Confirm Cancellation</button></a>
                                                    <!--<button class="active"><a href="<?php echo $this->webroot.'shipping_addresses/review';?>" style="color: #fff;">Confirm Cancellation</a></button>
						...
						<?php }
                                                    ...
                                                    if(isset($seller_response) && $seller_response==1 && $is_close==0){
                                                        echo '<a href="'.$this->webroot.'orders/dispute_details/'.base64_encode($order_details_id).'"><button class="active">Respond</button></a>';
                                                ...
                                                ?>
                                                 <a href="<?php echo $this->webroot.'orders/dispute_details/'.base64_encode($order_details_id);?>"><button class="active">View Details</button></a>    
                                                <?php
                                                }else{
                                                    if(count($prd_disput_details)< 1){
                                                        echo '<a href="Javascript: void(0);" class="add_tracking" id="'.base64_encode($order_details_id).'" style="color: #fff;"><button class="active">Add Tracking</button></a>';
                                                    }
                                                    if($extend_processing_time==1 && ($buyer_responce_processing_time==1 || $buyer_responce_processing_time==2)){
                                                ?>
                                                 <a href="Javascript: void(0);" class="seller_cancel_order" cancel_id="<?php echo $order_details_id;?>"><button type="button" class="active">Cancel Order</button></a> 
                                                <?php }?>
