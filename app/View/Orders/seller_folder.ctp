		    ...
		    <?php echo($this->element('user_leftbar'));?>
                    ...
                    <div class="col-md-9">
                        ...
                        <ul class="nav nav-tabs buyer-tab" role="tablist">
                            ...
                            <?php }?>
                            <li role="presentation" class=""><a href="<?php echo $this->webroot.'orders/seller_mail';?>">Inbox</a></li>
                            <li role="presentation" class=""><a href="<?php echo $this->webroot.'orders/seller_sent';?>" title="Sent">Sent</a></li>
                            <li role="presentation" class="folder active"><a href="<?php echo $this->webroot.'orders/seller_folder';?>">Folder</a></li>
                                    ...
                                    <table class="table buyer-msg-table">
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><a href="<?php echo $this->webroot.'orders/seller_folder/'.base64_encode($folder_id);?>"><?php echo $folder_name;?></a></td>
                                                <td><?php echo $order_date;?></td>
                                                <td><a href="<?php echo $this->webroot.'orders/seller_folder/'.base64_encode($folder_id);?>">View</a></td>
                                            </tr>    
                                        <?php 
                                            endforeach;
                                        }else{
