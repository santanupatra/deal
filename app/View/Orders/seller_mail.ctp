		    ...
		    <?php echo($this->element('user_leftbar'));?>
                    ...
                    <div class="col-md-9">
                        ...
                        <ul class="nav nav-tabs buyer-tab" role="tablist">
                            ...
                            <li role="presentation" class="active"><a href="<?php echo $this->webroot.'orders/seller_mail';?>">Inbox</a></li>
                            <li role="presentation" class=""><a href="<?php echo $this->webroot.'orders/seller_sent';?>" title="Sent">Sent</a></li>
                            <li role="presentation" class="folder"><a href="<?php echo $this->webroot.'orders/seller_folder';?>">Folder</a></li>
                                    ...
                                    <table class="table buyer-msg-table">
                                        ...
                                        if(count($messages_list)>0){
                                            ...
                                            foreach ($messages_list as $message): 
                                                ...
                                                $buyer_is_flag=isset($message['Comment']['seller_is_flag'])?$message['Comment']['seller_is_flag']:'';
                                                $seller_is_read=isset($message['Comment']['seller_is_read'])?$message['Comment']['seller_is_read']:'';
                                                if($seller_is_read==0){
                                        ...
                                        ?>
                                            <tr class="<?php echo $read_class;?>">
                                                <td>
                                                    <div class="flag"><a href="<?php echo $this->webroot.'orders/seller_flag/'.base64_encode($msg_id).'/'.base64_encode($buyer_is_flag);?>" <?php if($buyer_is_flag==1){ echo 'style="color: #b60e09;"';}?> class="fa fa-flag" onclick="return confirm('Are you Sure?');"></a></div>
                                                    <div class="chkbx"><input type="checkbox" name="del_msg[]" class="inbox_del_msg" value="<?php echo $msg_id;?>" /></div>
                                                </td>
                                                <td><?php echo $seller_name;?></td>
                                                <td><a href="<?php echo $this->webroot.'orders/seller_message_conversations/'.base64_encode($msg_thread_id);?>"><?php echo $order_subject;?></a><!--Order ID: Packaging Joint Shares ice--></td>
