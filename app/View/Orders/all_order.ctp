                                ...
                                <div class="col-md-12">
                                    <div class="order-search">
                                        ...
                                        <form class="form-inline" method="post" action="" name="">
                                            ...
                                            <div class="form-group">
                                                <input type="text" class="form-control" id="exampleInputPassword3" name="product_name" placeholder="Store name" value="<?php echo isset($product_name)?$product_name:'';?>">
                                            </div>
                                ...
                                <li>
                                    ...
                                    <div class="order-bottom">
                                            ...
                                            <div class="order_b_2 padding-top_center">
                                                <?php
                                                if($order_status=='U'){ /*echo '<p>Awaiting Shipment</p>';*/}elseif($order_status=='DP'){ if(isset($is_close) && $is_close==1){ echo '<p>Dispute Finished</p>';}else{ echo '<p>Dispute Finished</p><span>(Refund Progress)</span>';}}elseif($order_status=='F'){ echo '<p>Confirmation Received</p>';}elseif($order_status=='C'){ echo '<p>Cancelled Order</p>';}
                                                ?>
                                            ...
                                            <div class="order_b_3 padding-top_center">
                                                ...
                                                if($order_status=='C' && isset($seller_responce) && $seller_responce==0){
                                                    ...
                                                    echo '<p><b>Seller Accepted Cancelled Order</b></p>';
                                                }elseif($order_status=='U' && isset($seller_responce) && $seller_responce==2){
                                                    echo '<p><b>Seller Reject Cancelled Order</b></p>';
                                                }elseif($order_status=='C' && isset($seller_responce) && $seller_responce==3){
                                                    echo '<p><b>Seller Cancelled the Order</b></p>';
                                                    ...
                                                    //echo '<p><b>Seller Request for Extend Processing Time</b></p>';
                                                    echo '<p><b>Seller has requested extended delivery time please respond</b></p>';
                                                    ...
                                                    if(count($prd_disput_details)>0){
                                                        echo '<p><b>You Dispute Product.</b></p>';
                                            ...
                                            <div class="order_b_4 padding-top_center">
                                                ...
                                                if($order_status=='S'){
                                                ?>
                                                    <a href="Javascript: void(0);" class="OpenDispute" orderid="<?php echo $order_details_id;?>" amount="<?php echo $pay_amt;?>"><button class="active" style="height: auto !important;">Dispute</button></a>
                                                ...
                                                <?php }else{?>
                                                    <!--<a href="Javascript: void(0);" class="OpenDispute" orderid="<?php echo $order_details_id;?>" amount="<?php echo $pay_amt;?>"><button class="active" style="height: auto !important;">Dispute</button></a>-->
                                                <?php }?>
                                                <!--<button class="active"><a href="<?php echo $this->webroot.'products/view/'.base64_encode($product_id);?>" style="color: #fff;">Add to Cart</a></button>
