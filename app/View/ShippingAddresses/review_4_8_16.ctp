    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-6">
                ...
                <h3>1. Select your shipping information:</h3>
            ...
            <div class="col-lg-12">
                    <div class="detail-info-hold">
                        <p>Seller: <?php echo isset($SellerName)?$SellerName:'';?></p>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            <td class="prod-picture-hold">
                                                <div class="prod-picture"><img src="<?php echo $product['TempCart']['image']?>" alt=""></div>
                                                <div class="prod-info">
                                            ...
                                            <td><?php echo $product['TempCart']['quantity'];?> X US $<?php echo $product['TempCart']['price'];?></td>
                                            <td>
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            ...
                                            <div class="form-group">
                                                <textarea class="form-control" rows="4" name="order_message" id="order_message"></textarea>
                                            </div>
                                            <small class="gry-txt">Max. 1,000 English characters or Arabic numerals only. No HTML codes.</small>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <!--<h4 class="text-right"><span class="gry-txt">Total:</span> US $<?php echo $totalPrice;?></h4>-->
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-7 col-xs-7">
                            ...
                            <p class="text-right"><a href="Javascript: void(0);" class="btn btn-primary" onclick="gotoPaypal()">Pay Now</a></p>
                        </div>
                    </div>
            </div>
        </div>
