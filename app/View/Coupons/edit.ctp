                                            ...
                                            <div class="dash_middle_sec sequirity_info">
                                                ...
                                                <?php echo $this->Form->input('id');?>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-6">
                                                        <!--  <input type="text" class="form-control" id="inputEmail3" placeholder="">-->
                                                            <?php  echo $this->Form->input('coupon_code',array('required'=>'required','label'=>false,'class'=>'form-control','readonly'=>'readonly')); ?>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label for="CouponProducts" class="col-sm-4 control-label">Products:</label>
                                                        <div class="col-sm-6">
                                                            <select name="data[Coupon][valid]" id="CouponProducts" class="form-control" required="required">
                                                                <option value="">Select Product</option>
                                                                <option value="1" <?php if($this->request->data['Coupon']['valid']==1){ echo 'selected="selected"';}?>>All</option>
                                                                <?php
                                                                if(isset($PrdList) && count($PrdList)>0){
                                                                    foreach($PrdList as $key => $val){
                                                                ?>
                                                                    <option value="<?php echo $key;?>" <?php if($this->request->data['Coupon']['valid']==$key){ echo 'selected="selected"';}?>> <?php echo $val;?> </option>
                                                                <?php
                                                                    }
                                                                }
                                                                ?>
                                                    ...
                                                    <div class="form-group row">
                                                        <label for="inputEmail3" class="col-sm-4 control-label">%age off:</label>
                                                            <div class="col-sm-6">
                                                              <!--<input type="text" class="form-control" id="inputEmail3" placeholder="">-->
                                                    ...
                                                    <div class="form-group row">
                                                        <label for="inputEmail3" class="col-sm-4 control-label">Expiry Date:</label>
                                                            <div class="col-sm-6">
                                                            <!--  <input type="text" class="form-control" id="inputEmail3" placeholder="">-->
