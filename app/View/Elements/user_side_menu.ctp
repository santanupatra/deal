...
<div class="col-lg-3 col-12 side-bar">
        ...
        {?> class="active" <?php } ?>>
                            <a href="<?php echo($this->webroot);?>users/dashboard"><i class="fa fa-fw fa-user"></i> User Information<span class="fa arrow"></span></a>
                        </li>
        ...
        {?> class="active" <?php } ?>>
                        ...
                        <li <?php if($this->params['controller']=='products' && $this->params['action']=='add_product')
        {?> class="active" <?php } ?>>
                            <a href="<?php echo($this->webroot);?>products/add_product"><i class="fa fa-fw ion-cube"></i> Add Product</a>
                        </li>
                        
                        
                        <li <?php if($this->params['controller']=='products' && $this->params['action']=='list_product')
        {?> class="active" <?php } ?>>
                            <a href="<?php echo($this->webroot);?>products/list_product"><i class="fa fa-fw ion-cube"></i> Product List</a>
                        </li>
<!--                        <li <?php if($this->params['controller']=='coupons' && $this->params['action']=='add')
        ...
        {?> class="active" <?php } ?>>
                        ...
                        <li <?php if($this->params['controller']=='users' && $this->params['action']=='vendor_request')
        {?> class="active" <?php } ?>>
                            <a href="<?php echo($this->webroot);?>users/vendor_request"><i class="fa fa-fw ion-cube"></i> Setting</a>
                        </li>
