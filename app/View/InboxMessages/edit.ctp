...
<?php echo $this->Form->create('InboxMessage'); ?>
	<fieldset>
		<legend><?php echo __('Edit Inbox Message'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('InboxMessage.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('InboxMessage.id'))); ?></li>
