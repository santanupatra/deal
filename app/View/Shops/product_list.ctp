				...
				<?php echo $this->Form->create("Filter",array('class' => 'form-inline'));?>
				  <div class="form-group">
				    <div class="input-group">
				      <input style=" width: 72%;" type="text" class="form-control" name="data[Filter][keyword]" id="exampleInputAmount" placeholder="Keyword" value="<?php echo ((isset($this->request->params['named']['keyword']) && $this->request->params['named']['keyword']!='')?urldecode($this->request->params['named']['keyword']):'');?>">
				...
				<div class="row">
					...
					<div class="col-md-4">
                                        <?php if($featured['Product']['sale_on'] == "Y" && $featured['Product']['discount'] > 0){ ?>
                                            ...
                                            <p style="color:#FFF; font-weight:bold;    padding: 15px 18px; font-size:15px; text-align:center;"> <?php echo $featured['Product']['discount']; ?>% <br />Off</p>
                                            </div>
                                            <?php } ?>
						<div class="feature_box">
						
							<a href="<?php echo $this->webroot.'products/view/'.base64_encode($featured['Product']['id']).'/'.$featured['Product']['category_id'];?>"><div class="feature_box_img">
