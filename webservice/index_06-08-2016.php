...
// GRT PRODUCT ACCURACY RATING
	...
	$sqlgetTotalRating = "SELECT `id` FROM ratings WHERE `product_id`='" . $id . "'";
	$stmtTotalRating = $db->prepare($sqlgetTotalRating);
	$stmtTotalRating->execute();
	$getTotalRating = $stmtTotalRating->fetchObject();	
