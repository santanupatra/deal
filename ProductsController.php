...
class ProductsController extends AppController {
    ...
    public function admin_add() {
        ...
        */
        ...
        $this->set(compact('users', 'categories','colors', 'ships', 'is_featured', 'unit_type', 'sale_on', 'status', 'shipping_time', 'processing_time'));
    }
    ...
    public function edit($id = null) {
        ...
        $this->set(compact('user', 'colorprice', 'colors', 'status', 'categories', 'all_image', 'status', 'ships', 'sub_categories'));
    }
